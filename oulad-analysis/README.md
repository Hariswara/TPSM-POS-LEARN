...
### `outputs/`
This folder is for generated assets. Everything in here should be deterministically reproducible from the `data/` and the code in `notebooks/` or `src/`. Avoid committing massive models or data files unless strictly necessary; prefer recreating them via code.
